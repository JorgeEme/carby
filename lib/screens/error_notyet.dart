...
class NotCheckedIn extends StatefulWidget {
  const NotCheckedIn();

  @override
  _NotCheckedIn createState() => _NotCheckedIn();
}

class _NotCheckedIn extends State<NotCheckedIn>
        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  "Compte! No s'ha fet check encara",
